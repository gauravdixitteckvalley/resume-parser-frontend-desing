...
const ResumeList = (props) => {
  ...
  const handleStatusChange = (event, resume_id) => {
    dispatch(
      updateStatusField({ id: resume_id, candidate_status: event.target.value })
    );
    setSelectedOption(
      Object.assign({ ...selectedOption, [resume_id]: event.target.value })
    );
  };
  ...
  const _buildResumeListNew = (resumes, applicant_status) => {
    if (!_.isEmpty(resumes)) {
            ...
            <thead>
              <tr>
                ...
                <th>
                  Name
                  <button
                    onClick={() => onClickEventForSorting("name", "asc")}
                    className="icon-up"
                  >
                    <i className="mdi mdi-chevron-up"></i>
                  </button>
                  <button
                    onClick={() => onClickEventForSorting("name", "desc")}
                    className="icon-down"
                  >
                ...
                <th>
                  Email
                  <button
                    onClick={() => onClickEventForSorting("email", "asc")}
                    className="icon-up"
                  >
                    <i className="mdi mdi-chevron-up"></i>
                  </button>
                  <button
                    onClick={() => onClickEventForSorting("email", "desc")}
                    className="icon-down"
                  >
                    <i className="mdi mdi-chevron-down"></i>
                  </button>
                ...
                <th>
                  Phone
                  <button
                    onClick={() => onClickEventForSorting("phone", "asc")}
                    className="icon-up"
                  >
                    <i className="mdi mdi-chevron-up"></i>
                  </button>
                  <button
                    onClick={() => onClickEventForSorting("phone", "desc")}
                    className="icon-down"
                  >
                    <i className="mdi mdi-chevron-down"></i>
                  </button>
                ...
                <th>
                  ...
                  <button
                    onClick={() =>
                      onClickEventForSorting("candidate_status", "asc")
                    }
                    className="icon-up"
                  >
                    <i className="mdi mdi-chevron-up"></i>
                  ...
                  <button
                    onClick={() =>
                      onClickEventForSorting("candidate_status", "desc")
                    }
                    className="icon-down"
                  >
                    <i className="mdi mdi-chevron-down"></i>
                ...
                >
                  ...
                  <td className="actions icons-list my-mdi-cls">
                    <div className="actions-cls">
                      ...
                      <NavLink to={`/candidate/details/${data.id}`}>
                        <i
                      ...
                      <a
                        ...
                        style={{ cursor: "pointer" }}
                        onClick={(event) =>
                          _handleDelModalShowClick(event, data.id)
                        }
                      >
      ...
      return displayRecordNotFound("No Resume Found");
    }
  };
  ...
  const _handleChange = (event) => {
    ...
    if (name === "maxExp") setMaxExp(value);
    ...
    <ResumeStyle>
      ...
      <div className="row">
            ...
            <div className="card-body">
              <div className="template-demo mb-2">
                <NavLink to={"/resume/add"}>
                  <button type="button" className="btn btn-primary btn-fw mb-2">
                    Upload Resume
                  </button>
                </NavLink>
        ...
        {total > per_page ? (
          ...
          >
            <div className="">
              Showing {currentPage * Number(per_page) - Number(per_page)} to{" "}
