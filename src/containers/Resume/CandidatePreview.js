...
const CandidatePreview = (props) => {
    ...
    const manageButtonLinkByLoggedIn = (fields) => {
      if(user.isCandidateLogin){
        return (
          <>
            <Link to={`/candidate/details/edit/${user.id}`} className="btn btn-primary" target="_blank" rel="noreferrer"><button type="submit" className="btn btn-gradient-primary mb-2">Edit</button></Link>
          </>
        )
    ...
    return (
        <Fragment>
            ...
            <div className="page-header">
              <h3 className="page-title"> Candidate Preview</h3>
              {
