...
const Header = (props) => {
    ...
    return (
        ...
        //             </button>
        //             <h4 className="ms-3">VE Resumes</h4>
        //         </div>
        //         <div className="align-right">Loggedin User: <strong>{user.first_name || ''}</strong>
        //         <button className="btn btn-success align-right" style={{"marginLeft": "20px"}} onClick={() => _loggedOutUser()}>Logout</button>
        //         </div>
                ...
                <div class="navbar-menu-wrapper d-flex align-items-stretch">
                    ...
                    <div class="search-field d-none d-md-block">
                        <form class="d-flex align-items-center h-100" action="#">
                            ...
                            <input type="text" class="form-control bg-transparent border-0" placeholder="Search Resume" />
                            </div>
                        </form>
                    </div>
                    <ul class="navbar-nav navbar-nav-right">
                        ...
                        <a class="nav-link dropdown-toggle" id="profileDropdown" href="#" data-bs-toggle="dropdown" aria-expanded="false">
                            ...
                            <p class="mb-1 text-black">Sandip Ghosh</p>
                            </div>
                        </a>
                        <div class="dropdown-menu navbar-dropdown" aria-labelledby="profileDropdown">
                            ...
                            <button class="dropdown-item" href="#" onClick={() => _loggedOutUser()}>
